...
static class Program
{
    ...
    static int Main()
    {
        ...
        Eq(
            ...
            Hex(Sha256.Hash(Encoding.ASCII.GetBytes("abc"))),
            "SHA256(\"abc\")"
        );
        Eq(
            "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
            Hex(Sha256.Hash(Array.Empty<byte>())),
            "SHA256(\"\")"
        );
        // Multi-block (message spans the 56-byte padding boundary).
        Eq(
            "248d6a61d20638b8e5c026930c3e6039a33ce45964ff2167f6ecedd419db06c1",
            Hex(Sha256.Hash(Encoding.ASCII.GetBytes("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq"))),
            "SHA256(56-byte)"
        );
        ...
        Eq(
            ...
            HmacSha256.ComputeHex(Encoding.ASCII.GetBytes("Jefe"), Encoding.ASCII.GetBytes("what do ya want for nothing?")),
            "RFC4231 case 2"
        );
        // Case 6: key longer than the 64-byte block (forces the key-hashing path).
        Eq(
            "60e431591ee0b67f0d8a26aacbf5b77f8e0bc6213728c5140546040f0ee37f54",
            HmacSha256.ComputeHex(
                Repeat(0xaa, 131),
                Encoding.ASCII.GetBytes("Test Using Larger Than Block-Size Key - Hash Key First")
            ),
