...
<visuals> **Add starfield and nebulae background** - Create a dynamic starfield background with twinkling stars and distant nebulae to enhance the visual depth of space. Use layered backgrounds with parallax scrolling to give a sense of movement and scale as players navigate through the sectors. Consider implementing a day-night cycle or varying star density based on sector location for added immersion.
