...
public partial class CameraRig : Camera3D
{
    ...
    // look, and since the look IS the gun's aim the reticle sits dead centre in it.
    ...
    {
        Basis look = ship.Basis * TurretController.CamBasis; // Z = the look (= the aim), Y = the gunner's up
