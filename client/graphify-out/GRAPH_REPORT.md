# Graph Report - client  (2026-06-28)

## Corpus Check
- 40 files · ~50,506 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 883 nodes · 1394 edges · 44 communities (40 shown, 4 thin omitted)
...
1. `WorldRenderer` - 87 edges
2. `GameNetClient` - 49 edges
3. `PredictionController` - 36 edges
4. `Chat` - 35 edges
5. `SectorOverview` - 34 edges
6. `ServerInputOverlay` - 33 edges
7. `TargetMarkers` - 32 edges
8. `EngineGlow` - 30 edges
9. `ShipController` - 28 edges
10. `ConnectionManager` - 22 edges
...
Cohesion: 0.09
Nodes (16): CollisionWorld, Dictionary, bool, byte, ConnectionManager, DefRegistry, Dictionary, double (+8 more)
...
Cohesion: 0.05
Nodes (27): BinaryReader, CancellationToken, CancellationTokenSource, Channel, ClientWebSocket, ConcurrentQueue, HashSet, IceServerDto (+19 more)
...
Cohesion: 0.06
Nodes (24): AudioStream, AudioStreamPlayer, BaseDef, hp, Node, byte, Dictionary, HardpointDef (+16 more)
...
Cohesion: 0.20
Nodes (6): Node3D, BaseHealthBar, Color, MeshInstance3D, Node, StandardMaterial3D
...
Cohesion: 0.21
Nodes (6): Asteroid, AuthoredRadius, Axis, Mesh, Asteroid, Speed
...
Cohesion: 0.18
Nodes (5): Aleph, Base, Base, EventContext, Projectile
...
## Knowledge Gaps
- **286 isolated node(s):** `float`, `int`, `ShaderMaterial`, `bool`, `MeshInstance3D` (+281 more)
