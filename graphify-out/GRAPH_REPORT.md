...
## Corpus Check
- 79 files · ~108,951 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1425 nodes · 2401 edges · 82 communities (65 shown, 17 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8e124b17`
...
- **Why does `Node` connect `Community 77` to `Ship Controller Input`, `Community 51`, `Community 59`, `Community 69`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `Node3D` connect `Community 43` to `AlephView World State`, `Community 66`, `Community 65`, `Community 37`, `Client-Side Prediction`, `Community 69`, `Engine Glow Effects`, `Explosion Effect`, `Community 45`, `Remote Ship Networked`, `Starscape Background`?**
