...
## Corpus Check
- 67 files · ~96,305 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1232 nodes · 2078 edges · 73 communities (61 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `88a518de`
...
4. `SectorOverview` - 40 edges
5. `ClientHub` - 40 edges
...
## Knowledge Gaps
- **358 isolated node(s):** `float`, `int`, `ShaderMaterial`, `Marker3D`, `BaseBeacon` (+353 more)
...
- **Why does `WorldRenderer` connect `AlephView World State` to `Community 65`, `Community 67`, `PigAI NPC Behavior`, `Community 38`, `Community 41`, `Community 56`, `Community 58`, `Community 63`?**
