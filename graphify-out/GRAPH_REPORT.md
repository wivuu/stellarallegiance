...
## Summary
- 2327 nodes · 3854 edges · 169 communities (141 shown, 28 thin omitted)
...
1. `WorldRenderer` - 100 edges
2. `Simulation` - 79 edges
3. `GameNetClient` - 60 edges
4. `Simulation` - 51 edges
5. `ClientHub` - 44 edges
6. `Chat` - 41 edges
7. `SectorOverview` - 40 edges
8. `TargetMarkers` - 38 edges
9. `PredictionController` - 37 edges
10. `ServerInputOverlay` - 35 edges
...
Cohesion: 0.06
Nodes (17): bool, byte, ConnectionManager, DefRegistry, Dictionary, double, float, HashSet (+9 more)

### Community 2 - "Chat System"
Cohesion: 0.07
Nodes (25): ChatLine, ChatMessage, bool, Color, ConnectionManager, DbConnection, double, EventContext (+17 more)
...
Cohesion: 0.09
Nodes (19): CancellationToken, CancellationTokenSource, Color, ConcurrentQueue, ConnectionManager, Dictionary, HttpClient, JsonSerializerOptions (+11 more)
...
Cohesion: 0.06
Nodes (29): bool, DefRegistry, double, EngineGlow, float, int, IReadOnlyList, Label3D (+21 more)
...
Cohesion: 0.08
Nodes (20): AudioStreamPlayer3D, Color, CurveTexture, float, GradientTexture1D, GradientTexture2D, int, OmniLight3D (+12 more)

### Community 10 - "Lobby UI"
Cohesion: 0.10
Nodes (20): Action, Action, Button, ButtonVariant, ChamferButton, Color, ConnectionManager, DbConnection (+12 more)

### Community 11 - "Hit Flash Effect"
Cohesion: 0.10
Nodes (16): ArrayMesh, float, int, Shader, ShaderMaterial, ShaderMaterial, string, uint (+8 more)

### Community 12 - "Explosion Effect"
Cohesion: 0.12
Nodes (13): byte, Color, CurveTexture, double, float, GradientTexture1D, GradientTexture2D, MeshInstance3D (+5 more)

### Community 13 - "Target Markers HUD"
Cohesion: 0.07
Nodes (29): Basis, Camera3D, Basis, float, InputEvent, Vector3, WorldRenderer, bool (+21 more)
...
Cohesion: 0.04
Nodes (35): wivuullegiance, net8.0, SIPSorcery (10.0.9), net8.0, YamlDotNet (16.2.1), Microsoft.NET.Sdk, net8.0, Microsoft.NET.Sdk (+27 more)
...
Cohesion: 0.17
Nodes (17): HardpointKind, BaseDef, bool, byte, float, int, List, ShipStats (+9 more)
...
Cohesion: 0.11
Nodes (12): HeartbeatRequest, IReadOnlyCollection, LobbyEventBus, ConcurrentDictionary, int, IReadOnlyList, TimeSpan, InMemoryServerRegistry (+4 more)
...
Cohesion: 0.13
Nodes (16): IClientTransport, WebRtcListener, WebRtcTransport, PendingOfferDto, RTCDataChannel, CancellationToken, Channel, ChannelReader (+8 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (34): IEnumerable, Muzzle, object, Queue, Random, Action, bool, byte (+26 more)
...
Cohesion: 0.07
Nodes (34): DetRng, Rock, rx, ry, rz, bool, CapabilitySet, ConvexHull (+26 more)

### Community 47 - "Community 47"
Cohesion: 0.12
Nodes (11): BinaryWriter, List<HardpointDef>, Protocol, byte, ContentSet, int, IReadOnlyList<LobbyEntry>, ShipSim (+3 more)
...
Cohesion: 0.24
Nodes (8): JsonSchemaGenerator, HashSet, IEnumerable, Queue, INamingConvention, JsonObject, PropertyInfo, Type

### Community 59 - "Community 59"
Cohesion: 0.11
Nodes (11): bool, DbConnection, double, GameNetClient, Identity, int, string, Exception (+3 more)
...
Cohesion: 0.05
Nodes (31): AudioStream, AudioStreamPlayer, BaseDef, BaseDef, byte, ConnectionManager, DbConnection, Dictionary (+23 more)

### Community 63 - "Community 63"
Cohesion: 0.15
Nodes (13): DateTimeOffset, PendingOffer, CancellationToken, ConcurrentDictionary, IReadOnlyList, List, PendingOffer, string (+5 more)
...
Cohesion: 0.13
Nodes (17): LobbyRegistrar, bool, CancellationToken, CancellationTokenSource, Channel, ClientHub, ClientWebSocket, HttpClient (+9 more)
...
Cohesion: 0.06
Nodes (25): Button, CanvasLayer, bool, Button, ConnectionManager, DefRegistry, GameNetClient, InputEvent (+17 more)

### Community 70 - "Community 70"
Cohesion: 0.21
Nodes (13): AsteroidHull(), AsteroidSphere(), BaseHull(), BaseSphere(), Collide, IReadOnlyList<StaticBody>, Normal, ConvexHull (+5 more)
...
Cohesion: 0.22
Nodes (7): IDisposable, LobbyEvent, ChannelReader, ConcurrentDictionary, int, LobbyEventBus, Sub
...
Cohesion: 0.16
Nodes (11): Asteroid, Base, bool, Dictionary, IReadOnlyList, List, SimModel, StaticBody (+3 more)

### Community 81 - "Community 81"
Cohesion: 0.27
Nodes (7): Buildable, Core, HashSet, IEnumerable, TechSet, CoreValidator, ValidationResult
...
Cohesion: 0.21
Nodes (8): Camera3D, Color, float, GradientTexture2D, Texture2D, Vector2, Gradient, LensFlare

### Community 92 - "Community 92"
Cohesion: 0.24
Nodes (8): Core, IDeserializer, T, IDeserializer, ISerializer, Manifest, CoreSerializer, T

### Community 93 - "Community 93"
Cohesion: 0.20
Nodes (7): WebRtcSdp, RTCIceCandidate, CancellationToken, ConcurrentQueue, IEnumerable, RTCPeerConnection, Task

### Community 94 - "Community 94"
Cohesion: 0.36
Nodes (3): CancellationToken, RTCPeerConnection, Task

### Community 95 - "Community 95"
Cohesion: 0.33
Nodes (4): HardpointDef, IceServerDto, List, RTCIceServer

### Community 98 - "Community 98"
Cohesion: 0.20
Nodes (9): ContentValidator, BaseDef, HardpointDef, HashSet, IReadOnlyList, List, ShipClassDef, WeaponDef (+1 more)

### Community 99 - "Community 99"
Cohesion: 0.40
Nodes (4): ResolutionTests, Core, Fact, Faction
...
Cohesion: 0.18
Nodes (5): Capability, Capability, HashSet, CapabilitySet, TechSet
...
Cohesion: 0.27
Nodes (9): Expendable, Buildable, Core, IEnumerable, AllBuildables(), AllExpendables(), AllParts(), Merge() (+1 more)

### Community 107 - "Community 107"
Cohesion: 0.27
Nodes (7): Buildable, CapabilitySet, Core, IReadOnlyList, TechSet, TechState, BuildableResolver

### Community 108 - "Community 108"
Cohesion: 0.27
Nodes (7): Buildable, CapabilitySet, Core, Faction, TechSet, TechState, TechResolver

### Community 109 - "Community 109"
Cohesion: 0.15
Nodes (12): CheckBox, CheckButton, Action, ButtonVariant, ChamferButton, Color, HBoxContainer, Label (+4 more)

### Community 112 - "Community 112"
Cohesion: 0.29
Nodes (5): AttributeModifiers, Development, Faction, IEnumerable, AttributeResolver
...
Cohesion: 0.18
Nodes (10): Button, ChamferButton, Color, ConnectionManager, double, Label, TextStyle, ConnState (+2 more)

### Community 152 - "Community 152"
Cohesion: 0.23
Nodes (7): Camera3D, Color, float, int, Vector2, WorldRenderer, SystemRing

### Community 153 - "Community 153"
Cohesion: 0.17
Nodes (13): BuildableInfo, Buildable, Capability, CapabilitySet, Core, Faction, FactionAnalysis, IEnumerable (+5 more)

### Community 154 - "Community 154"
Cohesion: 0.15
Nodes (8): Color, float, string, MarginContainer, PanelContainer, BracketPanel, HairlinePanel, InsetWell

### Community 155 - "Community 155"
Cohesion: 0.30
Nodes (5): TechTreeReportTests, Core, Fact, FactionAnalysis, TechTreeDump
...
Cohesion: 0.24
Nodes (5): MeshInstance3D, Node, StandardMaterial3D, MeshInstance3D, BaseHealthBar

### Community 158 - "Community 158"
Cohesion: 0.35
Nodes (5): CanvasItem, Color, Vector2, Rect2, UiDraw
...
Cohesion: 0.28
Nodes (5): IEnumerable, List, pos, Vector2, RadarFrame
...
Cohesion: 0.33
Nodes (3): Color, int, SegmentedBar

## Knowledge Gaps
- **641 isolated node(s):** `float`, `int`, `ShaderMaterial`, `bool`, `Marker3D` (+636 more)
...
- **Why does `Node3D` connect `Starscape Background` to `AlephView World State`, `Community 66`, `Community 65`, `Community 37`, `Client-Side Prediction`, `PigAI NPC Behavior`, `Community 104`, `Engine Glow Effects`, `Hit Flash Effect`, `Explosion Effect`, `Community 45`, `Remote Ship Networked`, `Community 86`, `Community 89`, `Community 157`?**
