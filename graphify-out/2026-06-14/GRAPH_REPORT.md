...
## Corpus Check
- 63 files · ~68,199 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1168 nodes · 1949 edges · 69 communities (56 shown, 13 thin omitted)
...
Cohesion: 0.05
Nodes (30): Button, CanvasLayer, Button, Color, ConnectionManager, double, Label, Button (+22 more)
...
Cohesion: 0.11
Nodes (14): bool, Camera3D, Color, float, InputEvent, Label, MeshInstance3D, string (+6 more)
...
Cohesion: 0.23
Nodes (4): MeshInstance3D, ShipClass, Vector3, MeshInstance3D
...
## Knowledge Gaps
- **342 isolated node(s):** `float`, `int`, `ShaderMaterial`, `Material`, `MeshInstance3D` (+337 more)
...
- **Why does `Node3D` connect `SpaceTimeDB Module Config` to `AlephView World State`, `Community 37`, `Client-Side Prediction`, `Engine Glow Effects`, `Community 41`, `Hit Flash Effect`, `Explosion Effect`, `Community 45`, `Remote Ship Networked`, `Community 43`, `Dust Field Environment`, `Team Trail Effects`, `Starscape Background`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `Node` connect `Community 57` to `Community 16`, `Ship Controller Input`, `Community 51`, `Community 63`?**
