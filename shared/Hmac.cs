...
public static class Sha256
{
    ...
    public static byte[] Hash(byte[] message)
    {
        ...
        {
            for (int i = 0; i < 16; i++)
                w[i] = (uint)((data[chunk + 4 * i] << 24) | (data[chunk + 4 * i + 1] << 16)
        ...
        WriteBE(outp, 0, h0); WriteBE(outp, 4, h1); WriteBE(outp, 8, h2); WriteBE(outp, 12, h3);
        WriteBE(outp, 16, h4); WriteBE(outp, 20, h5); WriteBE(outp, 24, h6); WriteBE(outp, 28, h7);
        return outp;
    }
    ...
    {
        dst[o] = (byte)(v >> 24); dst[o + 1] = (byte)(v >> 16); dst[o + 2] = (byte)(v >> 8); dst[o + 3] = (byte)v;
    }
}
