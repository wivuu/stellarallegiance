...
namespace StellarAllegiance.Shared
{
    ...
    public static class GameContent
    {
        ...
        public static float MaxHull(byte classId) =>
            classId switch
            {
        ...
        public static float WeaponDamage(byte classId) =>
            classId switch
            {
        ...
        public static uint FireInterval(byte classId) =>
            classId switch
            {
        ...
        private static HardpointDef Hp(
            HardpointKind kind,
            byte index,
            float ox,
            float oy,
        ...
        private static ShipClassDef ShipDefFromStats(
            byte classId,
            string name,
            in ShipStats s,
            float maxHull,
            ...
            new()
            {
                ...
                MaxSpeed = s.MaxSpeed,
                Accel = s.Accel,
                RateYawDeg = s.RateYawDeg,
                RatePitchDeg = s.RatePitchDeg,
                RateRollDeg = s.RateRollDeg,
                DriftYawDeg = s.DriftYawDeg,
                DriftPitchDeg = s.DriftPitchDeg,
                SideMult = s.SideMult,
                BackMult = s.BackMult,
                AbAccel = s.AbAccel,
                AbOnRate = s.AbOnRate,
                AbOffRate = s.AbOffRate,
                MaxHull = maxHull,
        ...
        public static List<ShipClassDef> ShipClasses() =>
            new()
            {
                // Scout: a single main nozzle; one near-pinpoint cannon.
                ShipDefFromStats(
                    FlightModel.ClassScout,
                    "Scout",
                    FlightModel.Scout,
                    MaxHull(FlightModel.ClassScout),
                    Hps(
                ...
                ShipDefFromStats(
                    ...
                    "Fighter",
                    FlightModel.Fighter,
                    MaxHull(FlightModel.ClassFighter),
                    Hps(
                ...
                ShipDefFromStats(
                    ...
                    "Bomber",
                    FlightModel.Bomber,
                    MaxHull(FlightModel.ClassBomber),
                    Hps(
        ...
        public static List<WeaponDef> Weapons() =>
            new()
            {
                new()
                {
                    WeaponId = ScoutWeaponId,
                    Name = "Scout Cannon",
                    Damage = WeaponDamage(FlightModel.ClassScout),
                    FireIntervalTicks = FireInterval(FlightModel.ClassScout),
                ...
                new()
                {
                    WeaponId = FighterWeaponId,
                    Name = "Fighter Cannon",
                    Damage = WeaponDamage(FlightModel.ClassFighter),
                    FireIntervalTicks = FireInterval(FlightModel.ClassFighter),
                    ProjectileSpeed = ProjectileSpeed,
                    ProjectileLifeTicks = ProjectileLifeTicks,
                    ProjectileRadius = ProjectileRadius,
                ...
                new()
                {
                    WeaponId = BomberWeaponId,
                    Name = "Bomber Cannon",
                    Damage = WeaponDamage(FlightModel.ClassBomber),
                    FireIntervalTicks = FireInterval(FlightModel.ClassBomber),
                    ProjectileSpeed = ProjectileSpeed,
                    ProjectileLifeTicks = ProjectileLifeTicks,
                    ProjectileRadius = ProjectileRadius,
        ...
        public static List<BaseDef> Bases() =>
            new()
            {
                new()
                {
